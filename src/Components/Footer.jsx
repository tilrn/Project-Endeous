      ...
      <div className="footer-content">
        <div className="footer-section">
          ...
          <p>
            ...
            <br /> &nbsp; like everyone,
            <br /> &nbsp; this is a place for you too."
          </p>
          <p className="footer-quote">&nbsp;&nbsp;&nbsp;- Endej</p>
        </div>
        ...
        <div className="footer-section">
          ...
          <ul className="footer-links">
            ...
            <li>
              <Link to="/gallery">Creations</Link>
            </li>
            <li>
